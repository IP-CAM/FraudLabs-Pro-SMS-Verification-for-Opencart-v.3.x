...
class ControllerExtensionFraudFraudLabsProSmsVerification extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/fraud/fraudlabsprosmsverification', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['action'] = $this->url->link('extension/fraud/fraudlabsprosmsverification', 'user_token=' . $this->session->data['user_token'], true);
